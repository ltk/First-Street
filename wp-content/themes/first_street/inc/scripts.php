...
function roots_scripts() {
  ...
  // wp_enqueue_style('roots_bootstrap_style', '/wp-content/themes/first_street/css/bootstrap.css', false, null);
  ...
  if (current_theme_supports('bootstrap-responsive')) {
	...
	//wp_enqueue_style('roots_bootstrap_responsive_style', '/wp-content/themes/first_street/css/bootstrap-responsive.css', array('roots_bootstrap_style'), null);
  ...
  wp_enqueue_style('roots_app_style', '/wp-content/themes/first_street/css/app.css', false, null);
